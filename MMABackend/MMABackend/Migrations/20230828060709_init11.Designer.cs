...
namespace MMABackend.Migrations
{
    ...
    [Migration("20230828060709_init11")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CollectivePurchaserCollectiveSoldProduct", b =>
                {
                    b.Property<int>("CollectivePurchasersId")
                        .HasColumnType("INTEGER");

                    b.Property<int>("CollectiveSoldProductsId")
                        .HasColumnType("INTEGER");

                    b.HasKey("CollectivePurchasersId", "CollectiveSoldProductsId");

                    b.HasIndex("CollectiveSoldProductsId");

                    b.ToTable("CollectivePurchaserCollectiveSoldProduct");
                });
            ...
            modelBuilder.Entity("CollectivePurchaserCollectiveSoldProduct", b =>
                {
                    b.HasOne("MMABackend.DomainModels.Common.CollectivePurchaser", null)
                        .WithMany()
                        .HasForeignKey("CollectivePurchasersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MMABackend.DomainModels.Common.CollectiveSoldProduct", null)
                        .WithMany()
                        .HasForeignKey("CollectiveSoldProductsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
